     ...
     .then(dati => {
       ...
       lastUpdatedData.forEach(el => {
          ...
          div.innerHTML = 
          `
          <div class="card-custom p-3 pb-0 h-100 bg-info" data-region="${el.denominazione_regione}">
            <p class="text-white">${el.denominazione_regione}</p>
            <p class=" h5 mb-0 text-white ">${el.nuovi_positivi}</p>
            <hr>
            <p class="mb-0 text-white">Scopri di più</p>
          </div>
          `
