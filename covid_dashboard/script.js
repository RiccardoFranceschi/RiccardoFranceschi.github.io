     ...
     .then(dati => {
       ...
       lastUpdatedData.forEach(el => {
         ...
         div.innerHTML = 
         `
         <div class="card-custom bg-primary p-3 pb-0 h-100" data-region="${el.denominazione_regione}">
           <p class="text-light">${el.denominazione_regione}</p>
           <p class=" h5 mb-0 text-main text-light">${el.nuovi_positivi}</p>
           <hr class="bg-light">
           <p class="mb-0 text-light">Scopri di più</p>
         </div>
         `
